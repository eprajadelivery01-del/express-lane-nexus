...
import {
  ...
  MapPin, DollarSign, AlertTriangle, Settings, Menu, X, LogOut, User, MessageSquare, ChevronRight, ExternalLink, Ticket
} from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { label: "Bases & Regiões", icon: MapPin, href: "/admin/regions" },
