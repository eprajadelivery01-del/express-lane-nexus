...
export function SoundEnabler() {
  ...
  return (
    <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[9999] w-[90%] max-w-sm animate-in slide-in-from-bottom-10">
      <div className="bg-foreground text-background p-4 rounded-3xl shadow-2xl flex items-center gap-3 border border-border">
        ...
        <div className="flex-1">
          ...
          <p className="text-[10px] opacity-70">Para não perder corridas</p>
        </div>
        <button 
          onClick={enableSound}
          disabled={enabling}
