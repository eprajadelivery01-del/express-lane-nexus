    ...
    <div className={cn(
      ...
      <div className={cn(
        ...
        isMe 
          ...
          : "bg-card text-foreground rounded-2xl rounded-tl-none",
        ...
        showTail && !isMe && "before:content-[''] before:absolute before:top-0 before:-left-2 before:border-[10px] before:border-t-card after:border-r-transparent after:border-b-transparent after:border-l-transparent"
      )}>
