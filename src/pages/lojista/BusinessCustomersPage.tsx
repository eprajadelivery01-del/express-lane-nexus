...
export default function BusinessCustomersPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    // Como não há CRUD direto de 'clientes' numa tabela dedicada, 
    // apenas informamos que o gerenciamento é via entregas/perfis
    toast({ title: "Gerenciamento de clientes automático via Entregas" });
    setShowForm(false);
    setSaving(false);
  };
